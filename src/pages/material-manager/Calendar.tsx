...
const MaterialManagerCalendar = () => {
  ...
  const getHeaderText = () => (view === "day" ? format(currentDate, "PPP", { locale: ptBR }) : format(currentDate, "MMMM yyyy", { locale: ptBR }));

  if (loading) return <div className="flex items-center justify-center h-full"><p>Carregando calendário...</p></div>;
    ...
    <Card>
      <CardHeader className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <CardDescription>Visualize todas as atividades.</CardDescription>
        </div>
...
export default MaterialManagerCalendar;