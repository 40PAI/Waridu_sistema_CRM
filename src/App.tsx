...
function App() {
  ...
  const { materials: pageMaterials, rawMaterials, saveMaterial, addInitialStock, transferMaterial } = useMaterials();
        ...
        <BrowserRouter future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
          <Routes>
            ...
            <Route element={<ProtectedRoute />}>
              ...
              <Route path="/materials" element={<MaterialsPage materials={pageMaterials} locations={locations} onSaveMaterial={saveMaterial} onAddInitialStock={addInitialStock} onTransferMaterial={transferMaterial} history={[]} pendingRequests={pendingRequests} />} />
