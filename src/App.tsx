...
import FinanceDashboard from "@/pages/finance/Dashboard"; // New import
...
function App() {
  ...
  const { materials: pageMaterials, rawMaterials, saveMaterial, deleteMaterial, addInitialStock, transferMaterial } = useMaterials();
        ...
        <BrowserRouter future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
          <Routes>
            ...
            <Route element={<ProtectedRoute />}>
              ...
              <Route path="/materials" element={<MaterialsPage materials={pageMaterials} locations={locations} onSaveMaterial={saveMaterial} onAddInitialStock={addInitialStock} onTransferMaterial={transferMaterial} onDeleteMaterial={deleteMaterial} history={[]} pendingRequests={pendingRequests} />} />
              ...
              <Route path="/finance/dashboard" element={<FinanceDashboard />} /> {/* New route */}
